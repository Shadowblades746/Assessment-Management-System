...
import uk.ac.sheffield.com2008_team_27.service.JpaUserDetailService;
...
public class SecurityConfig {
    ...
    public SecurityConfig(JpaUserDetailService userDetailsService, RsaKeyProperties rsaKeys) {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                // to allow viewing the h2-console inside of firefox
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        config.setAllowedOrigins(List.of("http://localhost:5173", "http://localhost:52383", "http://localhost:52384"));
